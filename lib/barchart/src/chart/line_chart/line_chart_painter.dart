...
import 'package:social_graph/barchart/src/chart/base/axis_chart/axis_chart_painter.dart';
import 'package:social_graph/barchart/src/chart/base/base_chart/base_chart_painter.dart';

import 'package:social_graph/barchart/src/extensions/canvas_extension.dart';

import 'package:social_graph/barchart/src/extensions/path_extension.dart';
...
class LineChartPainter extends AxisChartPainter<LineChartData>
  ...
  void _drawTouchedSpotsIndicator(
    ...
    for (int i = 0; i < barData.showingIndicators.length; i++) {
      ...
      canvas.drawDashedLine(from, lineEnd, _touchLinePaint,
          indicatorData.indicatorBelowLine.dashArray);

      /// Draw the indicator dot
      if (indicatorData.touchedSpotDotData != null &&
